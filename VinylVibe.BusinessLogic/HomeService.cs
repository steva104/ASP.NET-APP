...
namespace VinylVibe.BusinessLogic
{
	public class HomeService :IHomeService
	{
		...
		public IEnumerable<Product> GetFilteredProducts(string searchString, string selectedGenre)
		{
			...
			{
				products = products.Where(p => p.Title.Contains(searchString, StringComparison.OrdinalIgnoreCase) ||
											   p.Artist.Contains(searchString, StringComparison.OrdinalIgnoreCase));
			}
